...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given pressure, internal energy, and bulk composition using the `PEFLSHdll` function.
    ///
    ...
    ///
    /// **Note:** For single-phase calculations, the subroutine `PEFL1` is faster.
    ///
    /// # Parameters
    ///
    /// - `P`: Pressure [kPa]
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - PEFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn pe_flash(P: f64, e: f64, z: &[f64]) -> Result<FlashOutput, RefpropError> {
