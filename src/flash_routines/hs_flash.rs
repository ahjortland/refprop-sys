...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given enthalpy, entropy, and bulk composition using the `HSFLSHdll` function.
    ///
    ...
    ///
    /// **Note:** For single-phase calculations, the subroutine `HSFL1` is faster.
    ///
    /// # Parameters
    ///
    /// - `h`: Enthalpy [J/mol]
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - HSFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn hs_flash(h: f64, s: f64, z: &[f64]) -> Result<FlashOutput, RefpropError> {
