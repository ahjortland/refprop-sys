...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given temperature, internal energy, and bulk composition using the `TEFLSHdll` function.
    ///
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - TEFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn te_flash(T: f64, e: f64, z: &[f64], kr: i32) -> Result<FlashOutput, RefpropError> {
        ...
        // Call TEFLSHdll within unsafe block
        unsafe {
            bindings::TEFLSHdll(
                T_ptr,
                e_ptr,
