...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given density, entropy, and bulk composition using the `DSFLSHdll` function.
    ///
    ...
    ///
    /// **Note:** For single-phase calculations, the subroutine `DSFL1` is faster.
    ///
    /// # Parameters
    ///
    /// - `D`: Density [mol/L]
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - DSFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn ds_flash(D: f64, s: f64, z: &[f64]) -> Result<FlashOutput, RefpropError> {
