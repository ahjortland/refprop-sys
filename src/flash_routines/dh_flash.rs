...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given density, enthalpy, and bulk composition using the `DHFLSHdll` function.
    ///
    ...
    ///
    /// **Note:** For single-phase calculations, the subroutine `DHFL1` is faster.
    ///
    /// # Parameters
    ///
    /// - `D`: Density [mol/L]
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - DHFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn dh_flash(D: f64, h: f64, z: &[f64]) -> Result<FlashOutput, RefpropError> {
