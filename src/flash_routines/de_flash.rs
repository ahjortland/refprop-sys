...
impl RefpropFunctionLibrary {
    /// Performs a flash calculation given density, internal energy, and bulk composition using the `DEFLSHdll` function.
    ///
    ...
    ///
    /// **Note:** For single-phase calculations, the subroutine `DEFL1` is faster.
    ///
    /// # Parameters
    ///
    /// - `D`: Density [mol/L]
    ...
    /// # References
    ///
    /// - [REFPROP Documentation - DEFLSHdll](https://pages.nist.gov/RefProp/documentation.html)
    pub fn de_flash(D: f64, e: f64, z: &[f64]) -> Result<FlashOutput, RefpropError> {
